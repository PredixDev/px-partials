...
function runBaseTests() {
  px_partials_1 = document.getElementById('px_partials_1');

  suite('Base Automation Tests for px-partials', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-partials fixture is created', function() {
      assert.isTrue(document.getElementById('px_partials_1') !== null);
    });
